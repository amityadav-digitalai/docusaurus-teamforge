...
xlr {
  release('Deployment pattern: Canary Release') {
    ...
    description 'This template implements the **Canary Deployment Pattern**\n' +
                ...
                '\n' +
                'For more information, please read [Perform canary deployments](https://docs.xebialabs.com/deploy/how-to/perform-canary-deployments.html) on our documentation site.'
