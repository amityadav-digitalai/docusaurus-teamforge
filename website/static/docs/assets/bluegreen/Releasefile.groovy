...
xlr {
  release('Blue / Green') {
    ...
    description 'This template implements the **Blue/Green Deployment Pattern**.\n' +
                ...
                '\n' +
                'For more information, please read [Perform Blue/Green deployments](https://docs.xebialabs.com/release/how-to/perform-blue-green-deployments.html) on our documentation site.'
